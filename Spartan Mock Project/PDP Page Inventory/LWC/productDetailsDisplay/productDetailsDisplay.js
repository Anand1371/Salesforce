...
export default class ProductDetailsDisplay extends NavigationMixin(
    ...
    get inStock()
    {
        return this.inventoryData.Status__c == 'In Stock';
    }

    /**
     * Gets whether Available Quantity is less than 5 or not.
     */
    get lessQuantityCheck()
    {
        return this.inventoryData.Available_for_Purchase__c<=5 && this.inventoryData.Available_for_Purchase__c>0;
    }
